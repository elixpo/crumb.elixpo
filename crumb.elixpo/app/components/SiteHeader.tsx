  ...
  return <header className="site-header">
    <div className="nav-shell">
      ...
      <nav className="desktop-nav" aria-label="Main navigation">
        <Link href="/features">Features</Link><Link href="/skills">Skills</Link><Link href="/plugins">Plugins</Link><Link href="/profile/connectors">Connectors</Link><Link href="/docs">Docs</Link><Link href="/about">About</Link>
      </nav>
