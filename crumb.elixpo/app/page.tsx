export default function Home() {
  return <main>
    <nav><a className="brand" href="/"><span className="mark small">c</span> crumb</a><div><a href="https://github.com/elixpo/crumb.elixpo">GitHub</a><a className="nav-cta" href="/api/auth/login">Sign in</a></div></nav>
    <section className="hero">
      ...
      <div className="actions"><a className="primary" href="https://github.com/elixpo/crumb.elixpo">Get Crumb</a><a className="secondary" href="/api/auth/login">Connect account</a></div>
