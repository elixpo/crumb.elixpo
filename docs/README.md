...
Documentation should live in the narrowest applicable folder. Product decisions belong in `product`, active engineering notes in `development`, and copied or integration-specific material in `reference`.
